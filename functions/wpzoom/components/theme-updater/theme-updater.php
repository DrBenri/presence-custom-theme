...
$strings = array(
	...
	'enter-key'                 => __( 'Enter your license key for this theme to enable <strong>theme updates</strong> and unlock all features.', 'wpzoom' ),
	...
	'renew'                     => __( 'Renew Your License', 'wpzoom' ),
	...
	'license-keys-do-not-match' => __( 'License key do not match.', 'wpzoom' ),
...
if ( current_theme_supports( 'wpz-onboarding' ) ) {
	include WPZOOM_INC . '/components/onboarding/class-wpzoom-onboarding-license.php';

	// Initiate activate license via AJAX from Onboarding.
	WPZOOM_Onboarding_License::get_instance( $config, $strings );
} elseif ( ! class_exists( 'EDD_Theme_Updater_Admin' ) ) {
