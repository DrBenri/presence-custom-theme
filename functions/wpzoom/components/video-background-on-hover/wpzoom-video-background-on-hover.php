...
if(!class_exists('WPZOOM_Video_Background_On_Hover')){
...
class WPZOOM_Video_Background_On_Hover {
	...
	public $allowed_screens = array( 'portfolio_item' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script(
			'giphy-background-moment-duration-js',
			WPZOOM::$wpzoomPath . '/components/video-background-on-hover/assets/js/moment-duration-format.js',
			array(
				'jquery',
		...
		wp_enqueue_script(
			'giphy-background',
			WPZOOM::$wpzoomPath . '/components/video-background-on-hover/assets/js/general.js',
			array(
				'jquery',
				'underscore',
				'wp-util',
