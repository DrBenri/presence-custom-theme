		...
		private function parse_declarations( $declarations, $tab = '', $media_type = 'all' ) {
			...
			foreach ( $declarations as $property => $value ) {
				...
				if ( 'font-family' !== $property ) {
					...
					$getAllFonts = zoom_customizer_get_all_fonts();

					//get category of the font
					$fontCategory = isset( $getAllFonts['google-fonts']['fonts'][ $value ]['category'] ) ? $getAllFonts['google-fonts']['fonts'][ $value ]['category'] : null;

					// Add fallback fonts to font family
					if( $fontCategory ) {
