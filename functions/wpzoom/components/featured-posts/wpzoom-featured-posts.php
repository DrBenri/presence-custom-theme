...
class WPZOOM_Featured_Posts {
	...
	public function __construct( $args, $component_directory_uri ) {
		...
		add_action(
			$this->get_ajax_action_name( 'set_featured' ),
			array(
				$this,
				'set_featured',
			)
		...
		add_action(
			$this->get_ajax_action_name( 'save_order' ),
			array(
				$this,
				'save_order',
			)
		...
		add_action(
			$this->get_ajax_action_name( 'reorder_items' ),
			array(
				$this,
				'reorder_items',
			)
		...
		add_action(
			$this->get_ajax_action_name( 'set_view_mode' ),
			array(
				$this,
				'set_view_mode',
			)
	...
	public function update_menu_order_in_posts() {
		...
		if ( $query->have_posts() ) {
			$max_order = $this->get_menu_order_limit( 'MAX' );
