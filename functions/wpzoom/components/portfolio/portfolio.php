...
class ZOOM_Portfolio {
	public function __construct() {
        ...
        add_filter( 'manage_portfolio_item_posts_columns', array( $this, 'add_thumbnail_column' ) );
        add_action( 'manage_portfolio_item_posts_custom_column', array( $this, 'display_thumbnail_column' ), 10, 2 );
        add_action( 'admin_head', array( $this, 'thumbnail_column_style' ) );
	...
	public function register_post_types() {
		$args = array(
			...
			'labels'              => array(
				...
				'add_new_item'       => __( 'Add New', 'wpzoom' ),
	...
	public function register_taxonomies() {
		...
		$args = array(
			...
			'labels'            => array(
				'name'                       => __( 'Categories', 'wpzoom' ),
				'singular_name'              => __( 'Category', 'wpzoom' ),
				'menu_name'                  => __( 'Categories', 'wpzoom' ),
				'name_admin_bar'             => __( 'Category', 'wpzoom' ),
				'search_items'               => __( 'Search Categories', 'wpzoom' ),
				'popular_items'              => __( 'Popular Categories', 'wpzoom' ),
				'all_items'                  => __( 'All Categories', 'wpzoom' ),
				'edit_item'                  => __( 'Edit Category', 'wpzoom' ),
				'view_item'                  => __( 'View Category', 'wpzoom' ),
				'update_item'                => __( 'Update Category', 'wpzoom' ),
				'add_new_item'               => __( 'Add New Category', 'wpzoom' ),
				'new_item_name'              => __( 'New Category Name', 'wpzoom' ),
				'separate_items_with_commas' => __( 'Separate categories with commas', 'wpzoom' ),
				'add_or_remove_items'        => __( 'Add or remove categories', 'wpzoom' ),
				'choose_from_most_used'      => __( 'Choose from the most used categories', 'wpzoom' ),
			),
		);
     ...
     */
    public function display_thumbnail_column( $column_name = false  ) {
    ...
    /**
     * Add the needed styles for the thumbnail column
     *
     * @param bool $column_name column name.
     */
    public function thumbnail_column_style() {
        echo '<style type="text/css">
            .column-portfolio_item_post_thumbs {
                width: 150px;
            }
            .portfolio_item_post_thumbs img {
                width: 150px;
                height: auto;
            }

            .portfolio_item_post_thumbs a + a:last-child {
                display: none;
            }
            ...
            @media screen and (max-width: 782px) {
                ...
                .column-portfolio_item_post_thumbs:before {
