...
class WPZOOM_Theme {
	...
	public static function header_code() {
		...
		$header_code = option::get( 'header_code' );
		$header_code = !empty( $header_code ) && is_string( $header_code ) ? trim( stripslashes( $header_code ) ): null;
	...
	public static function footer_code() {
		...
		$footer_code = option::get( 'footer_code' );
		$footer_code = !empty( $footer_code ) && is_string( $footer_code ) ? trim( stripslashes( $footer_code ) ): null;
